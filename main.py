...
########################### FUNÇÕES BANCO ###########################
    ...
    def cadastroUsuario(self):
        ...
        tupla_pessoa = (nome,data_nascimento,cpf,rg,data_emissao,orgao_exp,sexo,status,telefone,email,escolaridade,estado_civil,pessoa_deficiencia,data_inclusao,id_colaborador_resp)
