...
class Ui_Dados_Invalidos(object):
    def setupUi(self, Dialog):
        if not Dialog.objectName():
            Dialog.setObjectName(u"Dialog")
        ...
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.label_imagem_cancelar = QLabel(self.frame_2)
        self.label_imagem_cancelar.setObjectName(u"label_imagem_cancelar")
        self.label_imagem_cancelar.setMinimumSize(QSize(150, 150))
        self.label_imagem_cancelar.setMaximumSize(QSize(150, 150))
        self.label_imagem_cancelar.setPixmap(QPixmap(u"../icons/cancelar.png"))
        self.label_imagem_cancelar.setScaledContents(True)

        self.horizontalLayout_2.addWidget(self.label_imagem_cancelar)


        self.verticalLayout_2.addWidget(self.frame_2)

        self.label_pop_up_dados_invalidos = QLabel(self.frame_3)
        self.label_pop_up_dados_invalidos.setObjectName(u"label_pop_up_dados_salvos")
        self.label_pop_up_dados_invalidos.setFont(font)
        self.label_pop_up_dados_invalidos.setStyleSheet(u"")
        self.label_pop_up_dados_invalidos.setFrameShape(QFrame.NoFrame)
        self.label_pop_up_dados_invalidos.setAlignment(Qt.AlignCenter)
        self.label_pop_up_dados_invalidos.setWordWrap(False)

        self.verticalLayout_2.addWidget(self.label_pop_up_dados_invalidos)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Dialog", None))
        self.label_imagem_cancelar.setText("")
        self.label_pop_up_dados_invalidos.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"center\">DADOS INVÁLIDOS! TENTE NOVAMENTE!</p><p </body></html>", None))
    # retranslateUi
