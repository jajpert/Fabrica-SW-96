...
################################################################################
## Form generated from reading UI file 'telas_abreckqUvpX.ui'
##
...
"QPushButton:focus{outline: 0}")
        ...
        self.verticalLayout_112 = QVBoxLayout(self.page_parceiros_as)
        self.verticalLayout_112.setObjectName(u"verticalLayout_112")
        self.frame_138 = QFrame(self.page_parceiros_as)
        ...
        self.horizontalLayout_140 = QHBoxLayout(self.frame_138)
        ...
        self.horizontalLayout_140.addItem(self.horizontalSpacer_85)

        self.frame_161 = QFrame(self.frame_138)
        self.frame_161.setObjectName(u"frame_161")
        self.frame_161.setMinimumSize(QSize(0, 0))
        self.frame_161.setLayoutDirection(Qt.LeftToRight)
        self.frame_161.setStyleSheet(u"QFrame{padding: 3em;}")
        self.frame_161.setFrameShape(QFrame.StyledPanel)
        self.frame_161.setFrameShadow(QFrame.Raised)
        self.verticalLayout_169 = QVBoxLayout(self.frame_161)
        self.verticalLayout_169.setObjectName(u"verticalLayout_169")
        self.btn_cadastrar_clinica_as_2 = QPushButton(self.frame_161)
        self.btn_cadastrar_clinica_as_2.setObjectName(u"btn_cadastrar_clinica_as_2")
        self.btn_cadastrar_clinica_as_2.setMinimumSize(QSize(700, 154))
        self.btn_cadastrar_clinica_as_2.setMaximumSize(QSize(700, 154))
        self.btn_cadastrar_clinica_as_2.setFont(font7)
        self.btn_cadastrar_clinica_as_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_cadastrar_clinica_as_2.setLayoutDirection(Qt.RightToLeft)
        self.btn_cadastrar_clinica_as_2.setStyleSheet(u"QPushButton{color: #EC848C; background-color: #FEE4E1; border-radius: 20px ;border: none; padding: 1.5em}\n"
"QPushButton:hover{background-color: hsl(6, 94%, 92%)}\n"
"QPushButton:focus{outline: 0}")
        icon12 = QIcon()
        icon12.addFile(u"./icons/centro-medico.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastrar_clinica_as_2.setIcon(icon12)
        self.btn_cadastrar_clinica_as_2.setIconSize(QSize(80, 80))

        self.verticalLayout_169.addWidget(self.btn_cadastrar_clinica_as_2)

        self.btn_cadastrar_fornecedores_as_2 = QPushButton(self.frame_161)
        self.btn_cadastrar_fornecedores_as_2.setObjectName(u"btn_cadastrar_fornecedores_as_2")
        self.btn_cadastrar_fornecedores_as_2.setMinimumSize(QSize(700, 154))
        self.btn_cadastrar_fornecedores_as_2.setMaximumSize(QSize(700, 154))
        self.btn_cadastrar_fornecedores_as_2.setFont(font7)
        self.btn_cadastrar_fornecedores_as_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_cadastrar_fornecedores_as_2.setLayoutDirection(Qt.RightToLeft)
        self.btn_cadastrar_fornecedores_as_2.setStyleSheet(u"QPushButton{color: #EC848C; background-color: #FEE4E1; border-radius: 20px ;border: none; padding: 1.5em}\n"
"QPushButton:hover{background-color: hsl(6, 94%, 92%)}\n"
"QPushButton:focus{outline: 0}")
        icon13 = QIcon()
        icon13.addFile(u"./icons/fornecedor.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastrar_fornecedores_as_2.setIcon(icon13)
        self.btn_cadastrar_fornecedores_as_2.setIconSize(QSize(80, 80))

        self.verticalLayout_169.addWidget(self.btn_cadastrar_fornecedores_as_2)


        self.horizontalLayout_140.addWidget(self.frame_161)

        self.horizontalSpacer_86 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_140.addItem(self.horizontalSpacer_86)
...
"QPushButton:focus{outline:0}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_cadastrar_clinica_as_2.setText(QCoreApplication.translate("MainWindow", u"CLINICA", None))
        self.btn_cadastrar_fornecedores_as_2.setText(QCoreApplication.translate("MainWindow", u"FORNECEDORES", None))
