...
################################################################################
## Form generated from reading UI file 'telas_abrecuYhQrD.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_177.setContentsMargins(0, -1, 0, 0)
...
"QPushButton:focus{outline: 0} ")
        ...
        self.label_Abrec_Logo_Paint.setPixmap(QPixmap(u"icons/Abrec logo paint-02 (1).png"))
